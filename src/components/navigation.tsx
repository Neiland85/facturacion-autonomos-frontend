...
import { navigationItems } from "tailwind.config.js";

function NavigationLinks({ items, authenticated, pathname, onLinkClick }): any {
	return items
...
function MobileMenu({ mobileMenuOpen, setMobileMenuOpen, authenticated, pathname }) {
	return (
		<div
...
export function Navigation() {
	const myLocation = typeof window !== "undefined" ? window.location : undefined;
...
export const navigationItems = [
	{ name: "Dashboard", href: "/dashboard", icon: DashboardIcon, requiresAuth: true },
	{ name: "Usuarios", href: "/usuarios", icon: UserIcon, requiresAuth: true },
	{ name: "Clientes", href: "/clientes", icon: ClientsIcon, requiresAuth: true },
	{ name: "Facturas", href: "/facturas", icon: InvoiceIcon, requiresAuth: true },
	// ...otros items
];
